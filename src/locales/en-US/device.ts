export default {
  ...
  // frequency
  'device.form.title.frequency': 'Collection Frequency',
  'device.form.title.frequency.scan': 'Scanning Frequency',
  'device.form.title.frequency.request': 'Request Frequency',
  ...
  'device.form.title.host.plc': 'PLC IP Address',
