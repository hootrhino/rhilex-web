export default {
  ...
  'system.form.title.username': '用戶名',
  'system.form.title.password': '密碼',
  ...
  'system.form.placeholder.username': '請輸入用戶名',
  'system.form.placeholder.password': '請輸入密碼',
  ...
  'system.message.error.recovery': '只支持 .db 格式的文件，請檢查上傳文件格式',
  'system.message.error.upload': '只支持 zip 格式的文件，請檢查上傳文件格式',
