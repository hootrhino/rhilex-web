export default {
  ...
  'schemaMgt.form.title.round': '小数位',
  'schemaMgt.form.title.latitude': '纬度',
  'schemaMgt.form.title.longitude': '经度',
  ...
  'schemaMgt.form.placeholder.latitude': '请输入纬度',
  'schemaMgt.form.placeholder.longitude': '请输入经度',
