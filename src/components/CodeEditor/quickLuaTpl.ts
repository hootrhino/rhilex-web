  ...
  Http: [
    {
      ...
      variables: [{ label: `http 资源`, name: 'uuid', type: 'select', dataSource: 'outends' }],
    },
  ],
  Mqtt: [
    {
      ...
      variables: [{ label: `mqtt 资源`, name: 'uuid', type: 'select', dataSource: 'outends' }],
    },
  ],
  Mongo: [
    {
      ...
      variables: [{ label: `mongodb 资源`, name: 'uuid', type: 'select', dataSource: 'outends' }],
    },
  ],
  Debug: [
    {
