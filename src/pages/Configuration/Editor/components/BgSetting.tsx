...
import { Card, Checkbox, Col, Input, Row, Select, Slider } from 'antd';
...
export class Settings extends React.Component<Props, State> {
  ...
  render() {
    return (
      <Card title="Background Settings" size="small" bordered={false} style={{ width: 320 }}>
        <Row align="middle">
        ...
        <Row align="middle">
          <Col span={18} offset={6}>
            <Checkbox checked={this.state.showImage} onChange={this.onShowImageChanged}>
            ...
            <Row align="middle">
              ...
              <Col span={14}>
                ...
                >
                  ...
                  <Select.Option value={JSON.stringify({ width: 50, height: 50 })}>
                    {`{width: 50, height: 50 }`}
                  </Select.Option>
                </Select>
              </Col>
